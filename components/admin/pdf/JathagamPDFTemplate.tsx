        ...
        <div className="flex py-1 gap-4" style={{ display: 'flex', padding: '8px 0', gap: '16px' }}>
          <div className="flex-1 flex flex-col gap-0.5" style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <div className="grid grid-cols-[160px_10px_1fr] mt-1 text-[11px] leading-tight" style={{ display: 'flex', marginTop: '4px', fontSize: '11.5px', lineHeight: '1.4', alignItems: 'start' }}>
              <div className="font-bold text-emerald-950" style={{ fontWeight: 'bold', color: '#022c22', width: '160px' }}>தொடர்பு எண்</div>
              <div className="font-bold text-emerald-950 text-center" style={{ fontWeight: 'bold', color: '#022c22', width: '10px', textAlign: 'center' }}>:</div>
              <div className="font-bold text-red-600 pl-1" style={{ fontWeight: 'bold', color: '#dc2626', flex: '1', display: 'flex', alignItems: 'center', gap: '8px', paddingLeft: '4px' }}>
